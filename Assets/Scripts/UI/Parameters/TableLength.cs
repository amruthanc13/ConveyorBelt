...
public class TableLength : MonoBehaviour
{
    ...
    public void length1ButtonClick()
    {
        ...
        Debug.Log("Inside length1 Button Click");
    ...
    public void length2ButtonClick()
    {
        ...
        GameObject.Find("DateSpawner").transform.position = new Vector3(-45.44f, 14.50f, 18.89f);
    ...
    public void length3ButtonClick()
    {
        ...
        GameObject.Find("DateSpawner").transform.position = new Vector3(-59.60f, 14.50f, 18.89f);

        Debug.Log(GameObject.Find("DateSpawner").transform.position);
