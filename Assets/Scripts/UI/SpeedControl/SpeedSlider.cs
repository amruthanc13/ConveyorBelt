    ...
    public void speedSliderOnValueChanged(float value)
    {
        ...
        switch (value)
        {
            ...
            case 1:
                ...
                GameObject.Find("YOUTLine").GetComponent<LineAnimator>().animationDuration = 106f;
            ...
            case 2:
                ...
                GameObject.Find("YOUTLine").GetComponent<LineAnimator>().animationDuration = 53f;
            ...
            case 3:
                ...
                GameObject.Find("YOUTLine").GetComponent<LineAnimator>().animationDuration = 35.3f;
                break;
            case 4:
                ...
                GameObject.Find("YOUTLine").GetComponent<LineAnimator>().animationDuration = 26.5f;
                break;
            default:
                break;
        }
